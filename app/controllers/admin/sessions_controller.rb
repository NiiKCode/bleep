  ...
  class SessionsController < Admin::BaseController
    ...
    def update
      if @session.update(session_params)
        redirect_to schedule_admin_location_path(@session.location),
    ...
    def destroy
      ...
      redirect_to schedule_admin_location_path(location),
                  notice: "Session deleted successfully."
    end
    ...
    def session_params
      params.require(:session).permit(:title, :description, :date, :price)
    end
  end
end
